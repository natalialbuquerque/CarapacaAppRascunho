...
extension UIViewController {
    ...
    func showPreview() -> some View {
        Preview(viewController: self, novaViagemViewController: self, colocarDestinosViewController: self, construcaoDoRoteiroViewController: self, explorarViewController: self).statusBar(hidden: true)
    }
